...
const ContactMe = () => {
  return (
    <section className="bg-black text-gray-300 py-16 relative">
      {/* Main content */}
      ...
      <div className="mt-16 text-center relative">
        {/* Up Arrow Button */}
        <div className="bg-gray-700 hover:bg-gray-600 text-white w-12 h-12 rounded-full flex items-center justify-center mx-auto cursor-pointer">
          <FaChevronUp />
        </div>
