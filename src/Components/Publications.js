...
const Publications = () => {
  return (
    <section className="bg-gray-200 py-12 px-6 md:px-20" id="publications">
      <div className="max-w-6xl mx-auto">
        <h2 className="text-4xl font-bold mb-8 text-indigo-900 border-b-4 border-yellow-500 inline-block">
          Publications
        </h2>
       ...
       <p className="text-indigo-800 mb-1 flex items-center">
          ...
          <h4 className="font-bold text-lg text-indigo-800 mb-2">Abstract</h4>
        ...
        <div className="bg-white  mt-8 p-6 rounded-lg shadow-md">
          ...
          <h4 className="font-bold text-indigo-800  text-lg mb-2">Abstract</h4>
          <p className="text-indigo-800  mb-4">
